...
export default function DashboardPage() {
  ...
  const mockStats: DashboardStats = {
    totalSalesIncome: 125000,
    totalExpenses: 45000,
  };

  const mockExpenses: ExpenseModel[] = [
    { category: "Healthcare", amount: 15000, label: "Surgery" },
    { category: "Food", amount: 8000, label: "Groceries" },
    { category: "Transportation", amount: 12000, label: "Gas & Maintenance" },
    { category: "Utilities", amount: 10000, label: "Electricity & Water" },
  ];

  const mockSales: SaleModel[] = [
    { dateReceived: new Date('2021-01-01'), amount: 120000 },
    { dateReceived: new Date('2022-01-01'), amount: 180000 },
    { dateReceived: new Date('2023-01-01'), amount: 250000 },
    { dateReceived: new Date('2024-01-01'), amount: 320000 },
    { dateReceived: new Date('2025-01-01'), amount: 150000 },
  ];
      ...
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
        <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
          ...
          <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
            ...
            <div className="w-full mt-12 mb-12 space-y-8">
              <h2 className="text-xl font-bold mb-4 text-black dark:text-zinc-50">Financial Insights</h2>
              <FinancialPieChart stats={mockStats} expenses={mockExpenses} />
